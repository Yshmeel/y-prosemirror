      ...
      return {
        update: () => {
          ...
          if (pluginState.snapshot == null && pluginState.prevSnapshot == null) {
            if (changedInitialContent || !f.equalityDeep(view.state.doc.type.createAndFill().content.toJSON(), view.state.doc.content.toJSON())) {
...
const schema = new PModel.Schema({ nodes, marks });
