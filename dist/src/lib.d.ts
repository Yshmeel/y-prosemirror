 ...
 * @return {Y.Doc}
 */
export function prosemirrorToYDoc(doc: Node, xmlFragment: string, ydoc: any): any;
/**
 ...
 * @return {Y.Doc}
 */
export function prosemirrorJSONToYDoc(schema: Schema, state: any, xmlFragment: string, ydoc: any): any;
/**
